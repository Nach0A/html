...
class conexion_BD
{
    ...
    public function setNombreGrupo($nombre_grupo) { $this->nombre_grupo = $nombre_grupo; }
    ...
    public function getNumCalle() { return $this->num_calle; }
    ...
    public function mailUsado() {
        $gmailHash = hash('sha256', $this->correo);

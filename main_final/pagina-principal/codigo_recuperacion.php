...
<div class="login-wrapper">
    ...
    <div class="login-right fade-in">
        <div class="card p-4" id="recoverForm">
            <h4 class="text-center mb-3">Código de recuperación</h4>
            ...
            <form action="verificar_codigo.php" method="post">
                <input type="text" name="codigo" class="textwhite" placeholder="Código de verificación" maxlength="6" required>
                <button type="submit" class="btn btn-primary w-100 mt-3">Verificar código</button>
            </form>
